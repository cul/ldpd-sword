...
RSpec.describe Sword::Parsers::MetsParser do
  ...
  context "In mets file containing expected elements" do
    ...
    mets_file = Rails.root.join "spec/fixtures/files/xml/mets/mets_with_expected_elements.xml"
    # mets_file = file_fixture('xml/mets/mets_with_expected_elements.xml')
  ...
  context "In mets file containing only the <mets> element" do
    ...
    mets_file = Rails.root.join "spec/fixtures/files/xml/mets/empty_mets.xml"
    # mets_file = file_fixture('xml/mets/empty_mets.xml')
    mets_parser = Sword::Parsers::MetsParser.new
    mets_parser.parse(mets_file)
  ...
  context "In Proquest mets file containing only xmlData elements" do
    ...
    mets_file = Rails.root.join "spec/fixtures/files/xml/mets/proquest_etd_mets_actual_mets_file.xml"
    # mets_file = file_fixture('xml/mets/proquest_etd_mets_actual_mets_file.xml')
    mets_parser = Sword::Parsers::MetsParser.new
    mets_parser.parse(mets_file)
